<?php
/**
 * ELEMENTOR_PERSONALBLOCKQUOTES class.
 *
 * @category   Class
...
/**
 * Main Elementor PersonalBlockquotes Class
 *
 * The init class that runs the Elementor PersonalBlockquotes plugin.
 ...
 */
final class Elementor_PersonalBlockquotes {
	...
	public function i18n() {
		load_plugin_textdomain( 'elementor-personal-blockquotes' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ELEMENTOR_PERSONALBLOCKQUOTES ) );
...
// Instantiate ELEMENTOR_PERSONALBLOCKQUOTES.
new Elementor_PersonalBlockquotes();