...
/**
 * Main Elementor ImgAccordion Class
 *
 * The init class that runs the Elementor ImgAccordion plugin.
 ...
 */
final class Elementor_ImgAccordion {
	...
	public function i18n() {
		load_plugin_textdomain( 'elementor-imgaccordion' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ELEMENTOR_IMGACCORDION ) );
...
// Instantiate Elementor_ImgAccordion.
new Elementor_ImgAccordion();