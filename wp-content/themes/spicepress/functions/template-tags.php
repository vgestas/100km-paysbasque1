		...
		<div class="media">
			...
			<div class="media-body">
				...
				<ul class="blog-author-social">
					<?php $spicepress_facebook_profile = get_the_author_meta('facebook_profile');
					if ($spicepress_facebook_profile && $spicepress_facebook_profile != '') : ?>
						<li class="facebook"><a href="<?php echo esc_url($spicepress_facebook_profile); ?>"><i class="fa fa-facebook"></i></a></li>
					<?php endif; ?>
					<?php $spicepress_linkedin_profile = get_the_author_meta('linkedin_profile');
					if ($spicepress_linkedin_profile && $spicepress_linkedin_profile != '') : ?>
						<li class="linkedin"><a href="<?php echo esc_url($spicepress_linkedin_profile); ?>"><i class="fa fa-linkedin"></i></a></li>
					<?php endif; ?>
					<?php $spicepress_twitter_profile = get_the_author_meta('twitter_profile');
					if ($spicepress_twitter_profile && $spicepress_twitter_profile != '') : ?>
...
--------------------------------------------------------------*/
		...
		<?php if ($spicepress_menu_breakpoint < 991) { ?>@media (min-width: 200px) and (max-width: 991px) {
			.navbar-custom .container-fluid {
				width: auto !important;
			}
		}

		<?php } ?>@media (min-width: <?php echo $spicepress_menu_breakpoint + 1; ?>px) {
			.navbar-custom .container-fluid {
				width: 970px;
				padding-right: 15px;
				padding-left: 15px;
...
/*===================================================================================*/
		...
		@media (min-width: 100px) and (max-width: <?php echo $spicepress_menu_breakpoint; ?>px) {
			.cart-header {
				float: left;
				margin: 20px 7px 20px 15px !important;
			}
...
--------------------------------------------------------------*/
		...
		.navbar-overlapped .cart-header {
			width: 25px;
			height: 25px;
			margin: 33px 7px 32px 20px;
		}

		.navbar-overlapped .cart-header>a.cart-icon {
			color: #fff;
		...
		.navbar-overlapped .cart-header>a .cart-total {
			right: -11px;
			top: -4px;
		}
		...
		.navbar-overlapped.stiky-header .navbar-brand {
			padding: 10px 0px;
		}
		...
		.navbar-overlapped.stiky-header .navbar-nav>li>a {
			padding: 24px 10px;
		}

		.navbar-overlapped.stiky-header .cart-header {
...
--------------------------------------------------------------*/
		...
		@media (max-width: 500px) {
			...
			.navbar-overlapped .navbar-collapse.in {
				bottom: 0px;
			}

			.navbar-overlapped .navbar-collapse {
				bottom: 0px;
			}
...
--------------------------------------------------------------*/
		...
		.desktop-header .navbar-classic .navbar-nav>li>a {
			color: #fff;
			padding: 20px 25px;
		}
		...
		.navbar-classic .cart-header {
			width: 25px;
			height: 25px;
			margin: 18px 10px 17px 20px;
		}

		.navbar-classic .cart-header>a.cart-icon {
			color: #fff;
			border: 1px solid #ffffff;
		}
		...
		.navbar-classic .cart-header>a .cart-total {
			right: -11px;
			top: -4px;
		}

		.header-widget-info .navbar-brand {
			height: auto;
			padding: 15px 0px;
		}
...
-------------------------------------------------------------------------*/
		...
		@media (min-width: <?php echo $spicepress_menu_breakpoint + 1; ?>px) {
			...
			.navbar-header.align-right~.navbar-collapse {
				padding-left: 0;
			}
		}
